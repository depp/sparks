...
void Initialize(void)
{
	...
	{
		gWindPtr2 = NewCWindow(nil, &(qd.screenBits.bounds), "\pHaHaHa",
						false, plainDBox, (WindowPtr) -1, false, 0);
	...
	// Create back buffer
	error = NewGWorld(&gBackBuffer,8,&gBufferRect,gCTable,gTheDevice,noNewDevice);
	if (error != 0)
		GracefulExit();
