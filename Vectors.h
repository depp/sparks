...
public:
	...
	friend t_Vector2f operator*(const float a, const t_Vector2f &b);

	friend t_Vector2f operator*(const t_Vector2f &a, const float b);

	friend float operator*(const t_Vector2f &a, const t_Vector2f &b);

	friend t_Vector2f operator/(const t_Vector2f &a, const float &b);

	// Equality, Inequality
	friend int operator==(const t_Vector2f &a, const t_Vector2f &b);
	...
	// Matrix Functions
	friend t_Vector2f operator*(const t_Vector2f &a, const t_Matrix2f &b);

	friend t_Vector2f operator*(const t_Matrix2f &a, const t_Vector2f &b);
};
...
public:
	...
	// Addition, Subtraction, Negation, Scalar Product (x2), Dot Product
	friend t_Matrix2f operator+(const t_Matrix2f &a, const t_Matrix2f &b);

	friend t_Matrix2f operator-(const t_Matrix2f &a, const t_Matrix2f &b);

	friend t_Matrix2f operator-(const t_Matrix2f &a);

	friend t_Matrix2f operator*(const float a, const t_Matrix2f &b);

	friend t_Matrix2f operator*(const t_Matrix2f &a, const float b);
	...
	// Equality, Inequality
	friend int operator==(const t_Matrix2f &a, const t_Matrix2f &b);
